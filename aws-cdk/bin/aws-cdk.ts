...
import { BedrockKnowledgeBaseDemoStack } from '../lib/stacks/bedrock-knowledge-base-demo-stack';
...
new BedrockKnowledgeBaseDemoStack(app, 'BedrockKnowledgeBaseDemoStack', { env });
